...
function Head({ cartItems, setModel }) {
  ...
  return (
    <div className="w-full bg-white h-15 px-10 sticky top-0 z-50 py-3">
      <nav className="w-[80%] mx-auto flex items-center justify-between font-primary  sm:gap-3 sticky top-0 z-50 ">
        <div className="md:flex-1 ">
          <div>
            <img
              src={logo}
              alt="logo"
              className="w-[20px] md:w-[50px] inline"
            />
